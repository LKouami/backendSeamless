...
using Seamless.Domain.Validations.Faq;
...
namespace Seamless.API.App_Start
{
    public static class Mvc_Start
    {
        ...
        public static void UseDefaultAndCors(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            //Load dynamically
            var assemblyV1 = typeof(Seamless.API.V1.Controllers.ApiV1ControllerBase).Assembly;
            ...
            {
                opt.RegisterValidatorsFromAssembly(Assembly.GetAssembly(typeof(CreateFaqValidation)));
            })
        ...
        public static void UseAllMVCAndRouting(this IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //app.UseAutoMigrateDatabase<Seamless_DBContext>();
